    ...
    <div>
      ...
      >
        <g clipPath="url(#clip0_18746_5038)">
          <path
            opacity="0.8"
            d="M14.3334 11.6666C14.5643 11.6666 14.6797 11.6666 14.7732 11.7179C14.8504 11.7602 14.9222 11.8396 14.9566 11.9206C14.9982 12.0188 14.9877 12.1232 14.9668 12.3322C14.8581 13.4156 14.4852 14.4595 13.8765 15.3704C13.144 16.4668 12.1028 17.3212 10.8846 17.8258C9.66647 18.3304 8.32602 18.4624 7.03282 18.2052C5.73961 17.948 4.55172 17.313 3.61937 16.3807C2.68702 15.4483 2.05208 14.2604 1.79485 12.9672C1.53761 11.674 1.66964 10.3336 2.17422 9.11541C2.67881 7.89724 3.53329 6.85605 4.62962 6.12351C5.54055 5.51484 6.58446 5.14197 7.66784 5.03327C7.87681 5.01231 7.98129 5.00182 8.07948 5.04348C8.16049 5.07785 8.23988 5.14968 8.28216 5.22684C8.33342 5.32039 8.33342 5.4358 8.33342 5.66664V11C8.33342 11.2333 8.33342 11.35 8.37883 11.4391C8.41878 11.5175 8.48252 11.5813 8.56092 11.6212C8.65005 11.6666 8.76673 11.6666 9.00009 11.6666H14.3334Z"
            stroke="#F9F9F9"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M11.6667 2.33333C11.6667 2.1025 11.6667 1.98708 11.718 1.89353C11.7603 1.81637 11.8397 1.74454 11.9207 1.71017C12.0189 1.66851 12.1234 1.67899 12.3323 1.69995C13.856 1.85279 15.2884 2.52692 16.3808 3.61929C17.4732 4.71166 18.1473 6.14408 18.3001 7.66775C18.3211 7.87672 18.3316 7.98121 18.2899 8.0794C18.2555 8.16041 18.1837 8.2398 18.1065 8.28208C18.013 8.33333 17.8976 8.33333 17.6667 8.33333L12.3334 8.33333C12.1001 8.33333 11.9834 8.33333 11.8943 8.28792C11.8159 8.24797 11.7521 8.18423 11.7122 8.10583C11.6667 8.0167 11.6667 7.90002 11.6667 7.66667L11.6667 2.33333Z"
            stroke="#F9F9F9"
            strokeWidth="2"
            strokeLinecap="round"
            strokeLinejoin="round"
...
export const AttachmentIcon = () => {
  return (
    <div>
      ...
      >
        <path
          d="M15.8063 10.6312L7.3688 2.19373C5.96255 0.731231 3.6563 0.731231 2.1938 2.13748C0.731299 3.54373 0.731299 5.90623 2.1938 7.31248L2.25005 7.36873L3.82505 8.99998L4.61255 8.21248L2.9813 6.58123C2.02505 5.62498 2.02505 3.99373 2.9813 3.03748C3.93755 2.08123 5.5688 2.02498 6.52505 2.98123L6.5813 3.03748L14.9625 11.4187C15.975 12.375 15.975 14.0062 15.0188 14.9625C14.0625 15.975 12.4313 15.975 11.475 15.0187L11.4188 14.9625L7.2563 10.8C6.6938 10.2375 6.75005 9.33748 7.2563 8.83123C7.52596 8.58696 7.87682 8.45167 8.24067 8.45167C8.60453 8.45167 8.95538 8.58696 9.22505 8.83123L11.5313 11.1375L12.3188 10.35L9.9563 7.98748C9.71683 7.76102 9.43491 7.58419 9.12679 7.4672C8.81866 7.3502 8.49042 7.29535 8.161 7.30581C7.83157 7.31627 7.50748 7.39182 7.20739 7.52813C6.90731 7.66443 6.63717 7.85878 6.41255 8.09998C5.51255 9.05623 5.51255 10.575 6.41255 11.5875L10.6313 15.8062C12.0375 17.2687 14.3438 17.2687 15.8063 15.8625C17.2688 14.4562 17.2688 12.0937 15.8063 10.6312C15.8063 10.6875 15.8063 10.6312 15.8063 10.6312Z"
          fill="#F9F9F9"
        />
      </svg>
    </div>
  ...
  return (
    <div>
      <svg
        ...
        fill="none"
      >
        <g clipPath="url(#clip0_18803_172)">
          <path
  ...
  return (
    <div>
      <svg
        ...
        fill="none"
      >
        <g clipPath="url(#clip0_18803_175)">
          <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M10 18.125C12.1549 18.125 14.2215 17.269 15.7452 15.7452C17.269 14.2215 18.125 12.1549 18.125 10C18.125 7.84512 17.269 5.77849 15.7452 4.25476C14.2215 2.73102 12.1549 1.875 10 1.875C7.84512 1.875 5.77849 2.73102 4.25476 4.25476C2.73102 5.77849 1.875 7.84512 1.875 10C1.875 12.1549 2.73102 14.2215 4.25476 15.7452C5.77849 17.269 7.84512 18.125 10 18.125ZM10 20C12.6522 20 15.1957 18.9464 17.0711 17.0711C18.9464 15.1957 20 12.6522 20 10C20 7.34784 18.9464 4.8043 17.0711 2.92893C15.1957 1.05357 12.6522 0 10 0C7.34784 0 4.8043 1.05357 2.92893 2.92893C1.05357 4.8043 0 7.34784 0 10C0 12.6522 1.05357 15.1957 2.92893 17.0711C4.8043 18.9464 7.34784 20 10 20ZM11.25 13.75C11.25 14.0815 11.1183 14.3995 10.8839 14.6339C10.6495 14.8683 10.3315 15 10 15C9.66848 15 9.35054 14.8683 9.11612 14.6339C8.8817 14.3995 8.75 14.0815 8.75 13.75C8.75 13.4185 8.8817 13.1005 9.11612 12.8661C9.35054 12.6317 9.66848 12.5 10 12.5C10.3315 12.5 10.6495 12.6317 10.8839 12.8661C11.1183 13.1005 11.25 13.4185 11.25 13.75ZM10.9375 5.9375C10.9375 5.68886 10.8387 5.4504 10.6629 5.27459C10.4871 5.09877 10.2486 5 10 5C9.75136 5 9.5129 5.09877 9.33709 5.27459C9.16127 5.4504 9.0625 5.68886 9.0625 5.9375V10.3125C9.0625 10.5611 9.16127 10.7996 9.33709 10.9754C9.5129 11.1512 9.75136 11.25 10 11.25C10.2486 11.25 10.4871 11.1512 10.6629 10.9754C10.8387 10.7996 10.9375 10.5611 10.9375 10.3125V5.9375Z"
            fill="#E90516"
          />
        </g>
        <defs>
          <clipPath id="clip0_18803_175">
            <rect width="20" height="20" fill="white" />
          </clipPath>
        </defs>
      </svg>
  ...
  return (
    <div>
      <svg
        ...
        fill="none"
      >
        <g clipPath="url(#clip0_18803_181)">
          <path
...
// eslint-disable-next-line react/prop-types
export const DropdownBtnIcon = ({ className }) => {
  return (
    <div>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
//   const [size, setSize] = useState(window.innerWidth >= 768 ? 20 : 16);

//   useEffect(() => {
//     const handleResize = () => {
//       setSize(window.innerWidth >= 768 ? 20 : 16);
//     };
